...
<script>
    (function() {
        ...
        console.log("Current page:", currentPath); // Debug output
        
        if (currentPath === "" || currentPath === "/" || currentPath === "index.php") {
            currentPath = "products.php"; // Changed from dashboard.php to products.php
        }
        
        currentPath = currentPath.split("?")[0];
        console.log("Looking for path:", currentPath); // Debug output
        ...
        for (var i = 0; i < links.length; i++) {
            ...
            console.log("Link path:", linkPath); // Debug output
            
            links[i].classList.remove("active");
            
            if (linkPath === currentPath) {
                links[i].classList.add("active");
                console.log("Active set for:", linkPath); // Debug output
            }
        }
    })();
</script>